def addstudent():
    def submitadd():
        ...
        try:
            strr = 'insert into StdData values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
            mycursor.execute(strr,(id,name,mobile,year,email,address,gender,dob,addeddate,addedtime))
            con.commit()
    ...
    addroot.grab_set()
    addroot.geometry('470x550+250+100')
    ...
    yearlabel = Label(addroot, text='Enter year : ', bg='gold2', font=('times', 20, 'bold'), relief=GROOVE,
                       borderwidth=3, width=12, anchor='w')
    ...
    yearentry = Entry(addroot, font=('roman', 15, 'bold'), bd=5, textvariable=yearval)
    ...
    submitbtn = Button(addroot, text='Submit', font=('roman', 20, 'bold'), width=17, bd=5, activebackground='blue',
...
def searchstudent():
    def search():
        ...
        if(id != ''):
            ...
            strr = 'select *from StdData where year=%s'
            mycursor.execute(strr,(year))
            datas = mycursor.fetchall()
            studenttable.delete(*studenttable.get_children())
            for i in datas:
                vv = (i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], i[8], i[9])
            ...
            strr = 'select *from StdData where addeddate=%s'
    ...
    searchroot.grab_set()
    searchroot.geometry('470x600+220+80')
    searchroot.title('Student Manegement System')
    searchroot.config(bg='firebrick')
    ...
    yearlabel = Label(searchroot, text='Enter Mobile : ', bg='gold2', font=('times', 20, 'bold'), relief=GROOVE,
                        borderwidth=3, width=12, anchor='w')
    yearlabel.place(x=10, y=190)
    ...
    yearentry = Entry(searchroot, font=('roman', 15, 'bold'), bd=5, textvariable=yearval)
    yearentry.place(x=250, y=190)
...
def updatestudent():
    def update():
        ...
        strr = 'update StdData set name=%s,mobile=%s,year=%s,email=%s,address=%s,gender=%s,dob=%s,date=%s,time=%s where id=%s'
        mycursor.execute(strr,(name,mobile,year,email,address,gender,dob,date,time,id))
        con.commit()
    ...
    updateroot.grab_set()
    updateroot.geometry('470x650+220+30')
    updateroot.title('Student Management System')
    updateroot.config(bg='orange2')
    ...
    yearlabel = Label(updateroot, text='Enter year : ', bg='gold2', font=('times', 20, 'bold'), relief=GROOVE,
                        borderwidth=3, width=12, anchor='w')
    yearlabel.place(x=10, y=190)
    ...
    yearentry = Entry(updateroot, font=('roman', 15, 'bold'), bd=5, textvariable=yearval)
    yearentry.place(x=250, y=190)
...
def exportstudent():
    ...
    id, name, mobile, year, email, address, gender, dob, addeddate, addedtime = [], [], [], [], [], [], [], [], [], []
    for i in gg:
        content = studenttable.item(i)
        pp = content['values']
        id.append(pp[0]), name.append(pp[1]), mobile.append(pp[2]), year.append(pp[3]), email.append(pp[4]), address.append(pp[5]), gender.append(pp[6]),
        dob.append(pp[7]), addeddate.append(pp[8]), addedtime.append(pp[9])
    dd = ['id','Name','Mobile','year','Email','Address','Gender','D.O.B','Added Date','Added Time']
    df = pandas.DataFrame(list(zip(id,name,mobile,year,email,address,gender,dob,addeddate,addedtime)),columns=dd)
...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            return
        try:
            strr = 'create database SMSystem'
            mycursor.execute(strr)
            strr = 'use SMSystem'
            mycursor.execute(strr)
            strr = 'create table StdData(id int,name varchar(20),mobile varchar(12),year varchar(30),email varchar(30),address varchar(100),gender varchar(50),dob varchar(50),date varchar(50),time varchar(50))'
            mycursor.execute(strr)
...
root.geometry('1174x700+100+5')
root.iconbitmap('mana.ico')
root.resizable(True,False)
############################################################################################################  Frames
##---------------------------------------------------------------------------- dataentry frame

DataEntryFrame = Frame(root,bg='purple',relief=GROOVE,borderwidth=5)
DataEntryFrame.place(x=10,y=80,width=500,height=600)

frontlabel = Label(DataEntryFrame,text='-----------Welcome-----------',width=30,font=('arial',22,'italic bold'),bg='gold2')
frontlabel.pack(side=TOP,expand=True)
addbtn = Button(DataEntryFrame,text='1. Add Student',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=addstudent)
addbtn.pack(side=TOP,expand=True)

searchbtn = Button(DataEntryFrame,text='2. Search Student',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=searchstudent)
searchbtn.pack(side=TOP,expand=True)

deletebtn = Button(DataEntryFrame,text='3. Delete Student',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=deletestudent)
deletebtn.pack(side=TOP,expand=True)

updatebtn = Button(DataEntryFrame,text='4. Update Student',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=updatestudent)
updatebtn.pack(side=TOP,expand=True)

showallbtn = Button(DataEntryFrame,text='5. Show All',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=showstudent)
showallbtn.pack(side=TOP,expand=True)

exportbtn = Button(DataEntryFrame,text='6. Export Data',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=exportstudent)
exportbtn.pack(side=TOP,expand=True)

exitbtn = Button(DataEntryFrame,text='7. Exit',width=25,font=('chiller',20,'bold'),bd=6,bg='sky blue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=exitstudent)
exitbtn.pack(side=TOP,expand=True)

##---------------------------------------------------------------------------------
ShowDataFrame = Frame(root,bg='#306998',relief=GROOVE,borderwidth=5)
ShowDataFrame.place(x=550,y=80,width=620,height=600)

##-------------------------------------------------  Showdataframe
style = ttk.Style()
style.configure('Treeview.Heading',font=('algerian',20,'bold'),foreground='blue')
style.configure('Treeview',font=('times',15,'bold'),background='cyan',foreground='black')
scroll_x = Scrollbar(ShowDataFrame,orient=HORIZONTAL)
scroll_y = Scrollbar(ShowDataFrame,orient=VERTICAL)
studenttable = Treeview(ShowDataFrame,columns=('id','Name','Mobile No','year','Email','Address','Gender','D.O.B','Added Date','Added Time'),
...
studenttable.column('year',width=200)
...
connectbutton = Button(root,text='Connect To Database',width=23,relief=RIDGE,borderwidth=4,font=('chiller', 19, 'italic bold'),bg='green2',
